 ...
 */
class HayJointAccount implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'HayJointAccount';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('hay_account', $data ?? [], null);
    ...
    */
    ...
    public function setHayAccount(?\OpenAPI\Client\Model\HayAccount $hay_account): static
    {
        ...
        $this->container['hay_account'] = $hay_account;
     ...
     * Sets name
     *
     * @param string|null $name Name of the Group, if not provided a generic name associated with the client will be generated
     *
     * @return $this
     */
