...
/**
 * DirectCreditLiquidity Class Doc Comment
 *
 * @package  Shaype\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class DirectCreditLiquidity implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'DirectCreditLiquidity';
    ...
    */
     ...
     * @return float
     */
    public function getInbound(): float
    {
     ...
     * Sets inbound
     *
     * @param float $inbound inbound
     *
     * @return $this
     */
    public function setInbound(float $inbound): static
    {
        if (is_null($inbound)) {
     ...
     * @return float
     */
    public function getOutbound(): float
    {
     ...
     * Sets outbound
     *
     * @param float $outbound outbound
     *
     * @return $this
     */
    public function setOutbound(float $outbound): static
    {
        if (is_null($outbound)) {
