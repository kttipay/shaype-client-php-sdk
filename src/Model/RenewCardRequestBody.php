...
/**
 * RenewCardRequestBody Class Doc Comment
 *
 ...
 */
class RenewCardRequestBody implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'RenewCardRequestBody';
    ...
    */
     ...
     * Sets card_type
     *
     * @param string|null $card_type Type of card to renew into. Can convert virtual to physical card at a later time:  * **PHYSICAL** (default if not provided)  * **VIRTUAL**
     *
     * @return $this
     */
