...
/**
 * UpdateOverdraftLimitRequestBody Class Doc Comment
 *
 ...
 */
class UpdateOverdraftLimitRequestBody implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'UpdateOverdraftLimitRequestBody';
    ...
    */
     ...
     *
     * @param float $overdraft_limit The new overdraft limit to apply on Account, cannot exceed overdraft limit applied to the Product. Positive value to 2 decimal places.
     *
     * @return $this
     */
