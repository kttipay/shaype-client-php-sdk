 ...
 */
class AmendMandatePaymentTermsRequestBody implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'AmendMandatePaymentTermsRequestBody';
