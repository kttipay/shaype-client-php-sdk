 ...
 */
class ClientLiquidity implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'ClientLiquidity';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('non_scheme', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties(): array
    {
        ...
        if ($this->container['non_scheme'] === null) {
            $invalidProperties[] = "'non_scheme' can't be null";
        }
    ...
    public function setNonScheme(\OpenAPI\Client\Model\NonSchemeLiquidity $non_scheme): static
    {
        ...
        $this->container['non_scheme'] = $non_scheme;
