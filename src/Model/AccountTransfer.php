...
/**
 * AccountTransfer Class Doc Comment
 *
 ...
 */
class AccountTransfer implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'AccountTransfer';
    ...
    */
    ...
    public function listInvalidProperties(): array
    {
        ...
        if (!preg_match("/[\\d]{5,9}/", $this->container['account_number'])) {
            $invalidProperties[] = "invalid value for 'account_number', must be conform to the pattern /[\\d]{5,9}/.";
        }

        if ($this->container['bsb'] === null) {
            $invalidProperties[] = "'bsb' can't be null";
        }
        if (!preg_match("/[\\d]{6}/", $this->container['bsb'])) {
            $invalidProperties[] = "invalid value for 'bsb', must be conform to the pattern /[\\d]{6}/.";
        }
     ...
     * Sets account_number
     *
     * @param string $account_number Account number, 5-9 digits in length
     *
     * @return $this
     */
    public function setAccountNumber(string $account_number): static
    {
        ...
        if ((!preg_match("/[\\d]{5,9}/", ObjectSerializer::toString($account_number)))) {
            throw new InvalidArgumentException("invalid value for \$account_number when calling AccountTransfer., must conform to the pattern /[\\d]{5,9}/.");
        }
     ...
     * Sets bsb
     *
     * @param string $bsb BSB (Bank State Branch) of Account, 6 digits in length
     *
     * @return $this
     */
    public function setBsb(string $bsb): static
    {
        ...
        if ((!preg_match("/[\\d]{6}/", ObjectSerializer::toString($bsb)))) {
            throw new InvalidArgumentException("invalid value for \$bsb when calling AccountTransfer., must conform to the pattern /[\\d]{6}/.");
        }
    ...
    public function setRecipientName(string $recipient_name): static
    {
        ...
        if ((mb_strlen($recipient_name) > 140)) {
            throw new InvalidArgumentException('invalid length for $recipient_name when calling AccountTransfer., must be smaller than or equal to 140.');
        }
        if ((mb_strlen($recipient_name) < 1)) {
            throw new InvalidArgumentException('invalid length for $recipient_name when calling AccountTransfer., must be bigger than or equal to 1.');
        }
    ...
    public function setReference(?string $reference): static
    {
        ...
        if ((mb_strlen($reference) > 35)) {
            throw new InvalidArgumentException('invalid length for $reference when calling AccountTransfer., must be smaller than or equal to 35.');
        }
        if ((mb_strlen($reference) < 0)) {
            throw new InvalidArgumentException('invalid length for $reference when calling AccountTransfer., must be bigger than or equal to 0.');
        }
    ...
    public function setSenderName(?string $sender_name): static
    {
        ...
        if ((mb_strlen($sender_name) > 140)) {
            throw new InvalidArgumentException('invalid length for $sender_name when calling AccountTransfer., must be smaller than or equal to 140.');
        }
        if ((mb_strlen($sender_name) < 0)) {
            throw new InvalidArgumentException('invalid length for $sender_name when calling AccountTransfer., must be bigger than or equal to 0.');
        }
