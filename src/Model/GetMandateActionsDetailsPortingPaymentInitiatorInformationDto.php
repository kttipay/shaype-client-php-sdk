...
/**
 * GetMandateActionsDetailsPortingPaymentInitiatorInformationDto Class Doc Comment
 *
 ...
 */
class GetMandateActionsDetailsPortingPaymentInitiatorInformationDto implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'GetMandateActionsDetailsPortingPaymentInitiatorInformationDto';
    ...
    */
    ...
    public function setPartyIdentification(?string $party_identification): static
    {
        ...
        if ((!preg_match("/^[ -~]{1,35}$/", ObjectSerializer::toString($party_identification)))) {
            throw new InvalidArgumentException("invalid value for \$party_identification when calling GetMandateActionsDetailsPortingPaymentInitiatorInformationDto., must conform to the pattern /^[ -~]{1,35}$/.");
        }
    ...
    public function setPartyLegalName(?string $party_legal_name): static
    {
        ...
        if ((!preg_match("/^[ -~]{1,140}$/", ObjectSerializer::toString($party_legal_name)))) {
            throw new InvalidArgumentException("invalid value for \$party_legal_name when calling GetMandateActionsDetailsPortingPaymentInitiatorInformationDto., must conform to the pattern /^[ -~]{1,140}$/.");
        }
    ...
    public function setPartyName(?string $party_name): static
    {
        ...
        if ((!preg_match("/^[ -~]{1,140}$/", ObjectSerializer::toString($party_name)))) {
            throw new InvalidArgumentException("invalid value for \$party_name when calling GetMandateActionsDetailsPortingPaymentInitiatorInformationDto., must conform to the pattern /^[ -~]{1,140}$/.");
        }
    ...
    public function setPartyServicerBic(?string $party_servicer_bic): static
    {
        ...
        if ((!preg_match("/^[A-Z0-9]{4}[A-Z]{2}[A-Z0-9]{2}[A-Z0-9]{3}$/", ObjectSerializer::toString($party_servicer_bic)))) {
            throw new InvalidArgumentException("invalid value for \$party_servicer_bic when calling GetMandateActionsDetailsPortingPaymentInitiatorInformationDto., must conform to the pattern /^[A-Z0-9]{4}[A-Z]{2}[A-Z0-9]{2}[A-Z0-9]{3}$/.");
        }
