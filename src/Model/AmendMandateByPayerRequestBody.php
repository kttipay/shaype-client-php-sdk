...
/**
 * AmendMandateByPayerRequestBody Class Doc Comment
 *
 ...
 */
class AmendMandateByPayerRequestBody implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'AmendMandateByPayerRequestBody';
    ...
    */
    ...
    public function listInvalidProperties(): array
    {
        ...
        if ($this->container['debtor_account_id'] === null) {
            $invalidProperties[] = "'debtor_account_id' can't be null";
        }
     ...
     *
     * @param string $debtor_account_id The identifier of the debtor account.
     *
     * @return $this
     */
