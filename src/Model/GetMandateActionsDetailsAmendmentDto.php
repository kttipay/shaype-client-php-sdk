...
/**
 * GetMandateActionsDetailsAmendmentDto Class Doc Comment
 *
 ...
 */
class GetMandateActionsDetailsAmendmentDto implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'GetMandateActionsDetailsAmendmentDto';
    ...
    protected static array $openAPITypes = [
        ...
        'creditor_information' => '\OpenAPI\Client\Model\GetMandateActionsDetailsAmendmentCreditorInformationDto',
        'debtor_information' => '\OpenAPI\Client\Model\GetMandateActionsDetailsAmendmentDebtorInformationDto',
        'description' => 'string',
        'mandate_details_cx_extension' => '\OpenAPI\Client\Model\GetMandateActionsDetailsAmendmentMandateDetailsCxExtensionDto',
        'npp_backoffice_service' => 'string',
        'payment_information' => '\OpenAPI\Client\Model\GetMandateActionsDetailsAmendmentPaymentInformationDto',
        'payment_initiator_information' => '\OpenAPI\Client\Model\GetMandateActionsDetailsAmendmentPaymentInitiatorInformationDto',
    ...
    protected static array $openAPIFormats = [
        ...
        'description' => null,
        'mandate_details_cx_extension' => null,
    ...
    protected static array $openAPINullables = [
        ...
        'description' => false,
        'mandate_details_cx_extension' => false,
    ...
    protected static array $attributeMap = [
        ...
        'mandate_details_cx_extension' => 'mandateDetailsCxExtension',
    ...
    protected static array $setters = [
        ...
        'mandate_details_cx_extension' => 'setMandateDetailsCxExtension',
    ...
    protected static array $getters = [
        ...
        'mandate_details_cx_extension' => 'getMandateDetailsCxExtension',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('mandate_details_cx_extension', $data ?? [], null);
    ...
    */
     ...
     *
     * @param bool|null $automatic_extension_indicator Automatic renewal of a mandate arrangement at the end of the defined period (period start through period end).
     *
     * @return $this
     */
     ...
     *
     * @param string|null $besc_user_identification BECS user ID related to migrated DDR mandate. If this property is set to '-' it means that the BECS_user_identification has been cleared on the mandate.
     *
     * @return $this
     */
     ...
     *
     * @return \OpenAPI\Client\Model\GetMandateActionsDetailsAmendmentCreditorInformationDto|null
     */
    public function getCreditorInformation(): ?\OpenAPI\Client\Model\GetMandateActionsDetailsAmendmentCreditorInformationDto
    {
     ...
     *
     * @param \OpenAPI\Client\Model\GetMandateActionsDetailsAmendmentCreditorInformationDto|null $creditor_information creditor_information
     *
     * @return $this
     */
    public function setCreditorInformation(?\OpenAPI\Client\Model\GetMandateActionsDetailsAmendmentCreditorInformationDto $creditor_information): static
    {
     ...
     *
     * @return \OpenAPI\Client\Model\GetMandateActionsDetailsAmendmentDebtorInformationDto|null
     */
    public function getDebtorInformation(): ?\OpenAPI\Client\Model\GetMandateActionsDetailsAmendmentDebtorInformationDto
    {
     ...
     *
     * @param \OpenAPI\Client\Model\GetMandateActionsDetailsAmendmentDebtorInformationDto|null $debtor_information debtor_information
     *
     * @return $this
     */
    public function setDebtorInformation(?\OpenAPI\Client\Model\GetMandateActionsDetailsAmendmentDebtorInformationDto $debtor_information): static
    {
     ...
     * Sets description
     *
     * @param string|null $description Reason for the mandate setup as narrative text. If this property is set to '-' it means that the description has been cleared on the mandate.
     *
     * @return $this
     */
    public function setDescription(?string $description): static
    {
        ...
        if ((mb_strlen($description) > 140)) {
            throw new InvalidArgumentException('invalid length for $description when calling GetMandateActionsDetailsAmendmentDto., must be smaller than or equal to 140.');
        }
        if ((mb_strlen($description) < 1)) {
            throw new InvalidArgumentException('invalid length for $description when calling GetMandateActionsDetailsAmendmentDto., must be bigger than or equal to 1.');
        }
    ...
    /**
     * Gets mandate_details_cx_extension
     *
     * @return \OpenAPI\Client\Model\GetMandateActionsDetailsAmendmentMandateDetailsCxExtensionDto|null
     */
    public function getMandateDetailsCxExtension(): ?\OpenAPI\Client\Model\GetMandateActionsDetailsAmendmentMandateDetailsCxExtensionDto
    {
        return $this->container['mandate_details_cx_extension'];
    }

    /**
     * Sets mandate_details_cx_extension
     *
     * @param \OpenAPI\Client\Model\GetMandateActionsDetailsAmendmentMandateDetailsCxExtensionDto|null $mandate_details_cx_extension mandate_details_cx_extension
     *
     * @return $this
     */
    public function setMandateDetailsCxExtension(?\OpenAPI\Client\Model\GetMandateActionsDetailsAmendmentMandateDetailsCxExtensionDto $mandate_details_cx_extension): static
    {
        if (is_null($mandate_details_cx_extension)) {
            throw new InvalidArgumentException('non-nullable mandate_details_cx_extension cannot be null');
        }
        $this->container['mandate_details_cx_extension'] = $mandate_details_cx_extension;
     ...
     *
     * @param string|null $npp_backoffice_service Specifies a NPP backoffice service identification under which the mandate resides. If this property is set to '-' it means that the NPP backoffice service identification has been cleared on the mandate.
     *
     * @return $this
     */
    public function setNppBackofficeService(?string $npp_backoffice_service): static
    {
        ...
        if ((!preg_match("/^[ -~]{1,35}$/", ObjectSerializer::toString($npp_backoffice_service)))) {
            throw new InvalidArgumentException("invalid value for \$npp_backoffice_service when calling GetMandateActionsDetailsAmendmentDto., must conform to the pattern /^[ -~]{1,35}$/.");
        }
     ...
     *
     * @return \OpenAPI\Client\Model\GetMandateActionsDetailsAmendmentPaymentInformationDto|null
     */
    public function getPaymentInformation(): ?\OpenAPI\Client\Model\GetMandateActionsDetailsAmendmentPaymentInformationDto
    {
     ...
     *
     * @param \OpenAPI\Client\Model\GetMandateActionsDetailsAmendmentPaymentInformationDto|null $payment_information payment_information
     *
     * @return $this
     */
    public function setPaymentInformation(?\OpenAPI\Client\Model\GetMandateActionsDetailsAmendmentPaymentInformationDto $payment_information): static
    {
     ...
     *
     * @return \OpenAPI\Client\Model\GetMandateActionsDetailsAmendmentPaymentInitiatorInformationDto|null
     */
    public function getPaymentInitiatorInformation(): ?\OpenAPI\Client\Model\GetMandateActionsDetailsAmendmentPaymentInitiatorInformationDto
    {
     ...
     *
     * @param \OpenAPI\Client\Model\GetMandateActionsDetailsAmendmentPaymentInitiatorInformationDto|null $payment_initiator_information payment_initiator_information
     *
     * @return $this
     */
    public function setPaymentInitiatorInformation(?\OpenAPI\Client\Model\GetMandateActionsDetailsAmendmentPaymentInitiatorInformationDto $payment_initiator_information): static
    {
    ...
    public function setResolutionRequestedBy(?string $resolution_requested_by): static
    {
        ...
        if ((!preg_match("/^(?:[1-9]\\d{3}-(?:(?:0[1-9]|1[0-2])-(?:0[1-9]|1\\d|2[0-8])|(?:0[13-9]|1[0-2])-(?:29|30)|(?:0[13578]|1[02])-31)|(?:[1-9]\\d(?:0[48]|[2468][048]|[13579][26])|(?:[2468][048]|[13579][26])00)-02-29)T(?:[01]\\d|2[0-3]):[0-5]\\d:[0-5]\\d(?:\\.[0-9]{1,3})?(?:Z)$/", ObjectSerializer::toString($resolution_requested_by)))) {
            throw new InvalidArgumentException("invalid value for \$resolution_requested_by when calling GetMandateActionsDetailsAmendmentDto., must conform to the pattern /^(?:[1-9]\\d{3}-(?:(?:0[1-9]|1[0-2])-(?:0[1-9]|1\\d|2[0-8])|(?:0[13-9]|1[0-2])-(?:29|30)|(?:0[13578]|1[02])-31)|(?:[1-9]\\d(?:0[48]|[2468][048]|[13579][26])|(?:[2468][048]|[13579][26])00)-02-29)T(?:[01]\\d|2[0-3]):[0-5]\\d:[0-5]\\d(?:\\.[0-9]{1,3})?(?:Z)$/.");
        }
     ...
     *
     * @param string|null $short_description Short description of the reason for mandate setup as narrative text. If this property is set to '-' it means that the short description has been cleared on the mandate.
     *
     * @return $this
     */
    public function setShortDescription(?string $short_description): static
    {
        ...
        if ((mb_strlen($short_description) > 35)) {
            throw new InvalidArgumentException('invalid length for $short_description when calling GetMandateActionsDetailsAmendmentDto., must be smaller than or equal to 35.');
        }
        if ((mb_strlen($short_description) < 1)) {
            throw new InvalidArgumentException('invalid length for $short_description when calling GetMandateActionsDetailsAmendmentDto., must be bigger than or equal to 1.');
        }
    ...
    public function setTransferArrangement(?string $transfer_arrangement): static
    {
        ...
        if ((mb_strlen($transfer_arrangement) > 140)) {
            throw new InvalidArgumentException('invalid length for $transfer_arrangement when calling GetMandateActionsDetailsAmendmentDto., must be smaller than or equal to 140.');
        }
        if ((mb_strlen($transfer_arrangement) < 1)) {
            throw new InvalidArgumentException('invalid length for $transfer_arrangement when calling GetMandateActionsDetailsAmendmentDto., must be bigger than or equal to 1.');
        }
     ...
     *
     * @param string|null $validity_end_date End date of the validity of the mandate. If specified, the mandate is valid until 23:59:59.999 Australia Sydney time on this date. If this property is set to '1000-01-01' it means that the validity end date has been cleared on the mandate.
     *
     * @return $this
     */
    public function setValidityEndDate(?string $validity_end_date): static
    {
        ...
        if ((!preg_match("/^(?:[1-9]\\d{3}-(?:(?:0[1-9]|1[0-2])-(?:0[1-9]|1\\d|2[0-8])|(?:0[13-9]|1[0-2])-(?:29|30)|(?:0[13578]|1[02])-31)|(?:[1-9]\\d(?:0[48]|[2468][048]|[13579][26])|(?:[2468][048]|[13579][26])00)-02-29)$/", ObjectSerializer::toString($validity_end_date)))) {
            throw new InvalidArgumentException("invalid value for \$validity_end_date when calling GetMandateActionsDetailsAmendmentDto., must conform to the pattern /^(?:[1-9]\\d{3}-(?:(?:0[1-9]|1[0-2])-(?:0[1-9]|1\\d|2[0-8])|(?:0[13-9]|1[0-2])-(?:29|30)|(?:0[13578]|1[02])-31)|(?:[1-9]\\d(?:0[48]|[2468][048]|[13579][26])|(?:[2468][048]|[13579][26])00)-02-29)$/.");
        }
