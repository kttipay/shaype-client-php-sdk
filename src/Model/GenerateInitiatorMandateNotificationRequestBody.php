 ...
 */
class GenerateInitiatorMandateNotificationRequestBody implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'GenerateInitiatorMandateNotificationRequestBody';
    ...
    public const TRIGGER_MCRCMCRDMCRXMAMCMAMDMAMNMAMXMPOFMPOTMPOXMSCH = 'MCRC,MCRD,MCRX,MAMC,MAMD,MAMN,MAMX,MPOF,MPOT,MPOX,MSCH';
    ...
    {
        return [
            self::TRIGGER_MCRCMCRDMCRXMAMCMAMDMAMNMAMXMPOFMPOTMPOXMSCH,
        ];
    }
    ...
    */
     ...
     * Sets trigger
     *
     * @param string $trigger Notification trigger. * **MCRC**: Mandate Create Confirmed * **MCRD**: Mandate Create Declined * **MCRX**: Mandate Create Expired * **MAMC**: Mandate Amend Confirmed * **MAMD**: Mandate Amend Declined * **MAMN**: Mandate Amended * **MAMX**: Mandate Amend Expired * **MPOF**: Mandate Port Finalised * **MPOT**: Mandate Ported * **MPOX**: Mandate Port Expired * **MSCH**: Mandate Status Changed
     *
     * @return $this
     */
    public function setTrigger(string $trigger): static
    {
        ...
        if ((mb_strlen($trigger) > 4)) {
            throw new InvalidArgumentException('invalid length for $trigger when calling GenerateInitiatorMandateNotificationRequestBody., must be smaller than or equal to 4.');
        }
        if ((mb_strlen($trigger) < 4)) {
            throw new InvalidArgumentException('invalid length for $trigger when calling GenerateInitiatorMandateNotificationRequestBody., must be bigger than or equal to 4.');
        }
