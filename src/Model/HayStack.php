 ...
 */
class HayStack implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'HayStack';
    ...
    */
     ...
     * Sets balance
     *
     * @param float|null $balance Total balance available for use on Stack
     *
     * @return $this
     */
     ...
     * Sets closed_at_utc
     *
     * @param \DateTime|null $closed_at_utc DateTime in UTC format when the Stack was closed
     *
     * @return $this
     */
     ...
     * Sets created_at_utc
     *
     * @param \DateTime|null $created_at_utc DateTime in UTC format when the Stack was created
     *
     * @return $this
     */
     ...
     * Sets status
     *
     * @param string|null $status Stack status. Possible values:  * **OPEN**: Stack is active and in use  * **CLOSED**: Stack is inactive and can no longer be used
     *
     * @return $this
     */
