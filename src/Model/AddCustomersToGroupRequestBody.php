...
/**
 * AddCustomersToGroupRequestBody Class Doc Comment
 *
 ...
 */
class AddCustomersToGroupRequestBody implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'AddCustomersToGroupRequestBody';
    ...
    */
    ...
    public function listInvalidProperties(): array
    {
        ...
        if ($this->container['customer_hay_ids'] === null) {
            $invalidProperties[] = "'customer_hay_ids' can't be null";
        }
     ...
     *
     * @param string[] $customer_hay_ids Unique identifiers (UUID) of the Customer(s) associated to this Group
     *
     * @return $this
     */
