...
/**
 * GetMandateActionsDetailsCreationCreditorInformationDto Class Doc Comment
 *
 ...
 */
class GetMandateActionsDetailsCreationCreditorInformationDto implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'GetMandateActionsDetailsCreationCreditorInformationDto';
    ...
    */
    ...
    public function listInvalidProperties(): array
    {
        ...
        if ($this->container['account_identification_type_code'] === null) {
            $invalidProperties[] = "'account_identification_type_code' can't be null";
        }
        ...
        if ($this->container['ultimate_party_name'] === null) {
            $invalidProperties[] = "'ultimate_party_name' can't be null";
        }
        if (!preg_match("/^[ -~]{1,140}$/", $this->container['ultimate_party_name'])) {
     ...
     *
     * @param string|null $account_alias_identification Identification used to indicate the account identification under another specified name.
     *
     * @return $this
     */
    public function setAccountAliasIdentification(?string $account_alias_identification): static
    {
        ...
        if ((mb_strlen($account_alias_identification) > 2048)) {
            throw new InvalidArgumentException('invalid length for $account_alias_identification when calling GetMandateActionsDetailsCreationCreditorInformationDto., must be smaller than or equal to 2048.');
        }
        if ((mb_strlen($account_alias_identification) < 1)) {
            throw new InvalidArgumentException('invalid length for $account_alias_identification when calling GetMandateActionsDetailsCreationCreditorInformationDto., must be bigger than or equal to 1.');
        }
     ...
     * Sets account_id
     *
     * @param string|null $account_id Platform identifier of the creditor account
     *
     * @return $this
     */
     ...
     *
     * @param string|null $account_identification_issuer Entity or classification under which the identification is assigned.
     *
     * @return $this
     */
    public function setAccountIdentificationIssuer(?string $account_identification_issuer): static
    {
        ...
        if ((!preg_match("/^[ -~]{1,35}$/", ObjectSerializer::toString($account_identification_issuer)))) {
            throw new InvalidArgumentException("invalid value for \$account_identification_issuer when calling GetMandateActionsDetailsCreationCreditorInformationDto., must conform to the pattern /^[ -~]{1,35}$/.");
        }
     ...
     *
     * @param string $account_identification_type_code Type of account identification, in a coded form. * **BASIC_BANK_ACCOUNT_NUMBER**: Basic Bank Account Number * **ALIAS**: Alias Identification
     *
     * @return $this
     */
    ...
    public function setAccountNumber(?string $account_number): static
    {
        ...
        if ((!preg_match("/^[ -~]{11,15}$/", ObjectSerializer::toString($account_number)))) {
            throw new InvalidArgumentException("invalid value for \$account_number when calling GetMandateActionsDetailsCreationCreditorInformationDto., must conform to the pattern /^[ -~]{11,15}$/.");
        }
     ...
     *
     * @param string|null $account_servicer_bic Party that manages the account on behalf of the account owner, includes managing the registration and booking of entries on the account, calculating balances on the account and providing information about the account.
     *
     * @return $this
     */
    public function setAccountServicerBic(?string $account_servicer_bic): static
    {
        ...
        if ((!preg_match("/^[A-Z0-9]{4}[A-Z]{2}[A-Z0-9]{2}[A-Z0-9]{3}$/", ObjectSerializer::toString($account_servicer_bic)))) {
            throw new InvalidArgumentException("invalid value for \$account_servicer_bic when calling GetMandateActionsDetailsCreationCreditorInformationDto., must conform to the pattern /^[A-Z0-9]{4}[A-Z]{2}[A-Z0-9]{2}[A-Z0-9]{3}$/.");
        }
     ...
     *
     * @param string|null $full_legal_account_name Full Legal Account Name recorded by the Account Server in their records.
     *
     * @return $this
     */
    public function setFullLegalAccountName(?string $full_legal_account_name): static
    {
        ...
        if ((!preg_match("/^[ -~]{1,140}$/", ObjectSerializer::toString($full_legal_account_name)))) {
            throw new InvalidArgumentException("invalid value for \$full_legal_account_name when calling GetMandateActionsDetailsCreationCreditorInformationDto., must conform to the pattern /^[ -~]{1,140}$/.");
        }
    ...
    public function setPartyIdentification(?string $party_identification): static
    {
        ...
        if ((!preg_match("/^[ -~]{1,35}$/", ObjectSerializer::toString($party_identification)))) {
            throw new InvalidArgumentException("invalid value for \$party_identification when calling GetMandateActionsDetailsCreationCreditorInformationDto., must conform to the pattern /^[ -~]{1,35}$/.");
        }
    ...
    public function setPartyName(string $party_name): static
    {
        ...
        if ((!preg_match("/^[ -~]{1,140}$/", ObjectSerializer::toString($party_name)))) {
            throw new InvalidArgumentException("invalid value for \$party_name when calling GetMandateActionsDetailsCreationCreditorInformationDto., must conform to the pattern /^[ -~]{1,140}$/.");
        }
     ...
     *
     * @param string|null $party_reference Specifies underlying reference associated with the mandate as provided by party, for example Customer Reference, Customer Number, Membership Number, Subscription Number, or Name.
     *
     * @return $this
     */
    public function setPartyReference(?string $party_reference): static
    {
        ...
        if ((!preg_match("/^[ -~]{1,35}$/", ObjectSerializer::toString($party_reference)))) {
            throw new InvalidArgumentException("invalid value for \$party_reference when calling GetMandateActionsDetailsCreationCreditorInformationDto., must conform to the pattern /^[ -~]{1,35}$/.");
        }
     ...
     *
     * @param string $ultimate_party_name Name by which the ultimate party is known and which is usually used to identify that party.
     *
     * @return $this
     */
    public function setUltimatePartyName(string $ultimate_party_name): static
    {
        ...
        if ((!preg_match("/^[ -~]{1,140}$/", ObjectSerializer::toString($ultimate_party_name)))) {
            throw new InvalidArgumentException("invalid value for \$ultimate_party_name when calling GetMandateActionsDetailsCreationCreditorInformationDto., must conform to the pattern /^[ -~]{1,140}$/.");
        }
