...
/**
 * GenerateRapainMandateInformation Class Doc Comment
 *
 ...
 */
class GenerateRapainMandateInformation implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'GenerateRapainMandateInformation';
    ...
    */
    ...
    public function listInvalidProperties(): array
    {
        ...
        if (!preg_match("/^[ -~]{1,140}$/", $this->container['initiating_party_name'])) {
     ...
     *
     * @param string $initiating_party_name The party that initiates the credit transfer on behalf of the debtor.
     *
     * @return $this
     */
    public function setInitiatingPartyName(string $initiating_party_name): static
    {
        ...
        if ((!preg_match("/^[ -~]{1,140}$/", ObjectSerializer::toString($initiating_party_name)))) {
            throw new InvalidArgumentException("invalid value for \$initiating_party_name when calling GenerateRapainMandateInformation., must conform to the pattern /^[ -~]{1,140}$/.");
        }
    ...
    public function setMandateIdentification(string $mandate_identification): static
    {
        ...
        if ((!preg_match("/^[a-f0-9]{12}1[a-f0-9]{3}[89ab][a-f0-9]{15}$/", ObjectSerializer::toString($mandate_identification)))) {
            throw new InvalidArgumentException("invalid value for \$mandate_identification when calling GenerateRapainMandateInformation., must conform to the pattern /^[a-f0-9]{12}1[a-f0-9]{3}[89ab][a-f0-9]{15}$/.");
        }
