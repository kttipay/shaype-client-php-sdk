...
/**
 * BPayBillerRequestBody Class Doc Comment
 *
 ...
 */
class BPayBillerRequestBody implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'BPayBillerRequestBody';
    ...
    */
    ...
    public function setBillerCode(string $biller_code): static
    {
        ...
        if ((mb_strlen($biller_code) > 10)) {
            throw new InvalidArgumentException('invalid length for $biller_code when calling BPayBillerRequestBody., must be smaller than or equal to 10.');
        }
        if ((mb_strlen($biller_code) < 3)) {
            throw new InvalidArgumentException('invalid length for $biller_code when calling BPayBillerRequestBody., must be bigger than or equal to 3.');
        }
     ...
     * Sets reference
     *
     * @param string $reference BPAY biller reference. It must be of length 2 to 20 digits
     *
     * @return $this
     */
    public function setReference(string $reference): static
    {
        ...
        if ((mb_strlen($reference) > 20)) {
            throw new InvalidArgumentException('invalid length for $reference when calling BPayBillerRequestBody., must be smaller than or equal to 20.');
        }
        if ((mb_strlen($reference) < 2)) {
            throw new InvalidArgumentException('invalid length for $reference when calling BPayBillerRequestBody., must be bigger than or equal to 2.');
        }
