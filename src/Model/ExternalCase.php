...
/**
 * ExternalCase Class Doc Comment
 *
 * @description Case
 * @package  Shaype\Client
 * @author   OpenAPI Generator team
 ...
 */
class ExternalCase implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'ExternalCase';
    ...
    public const OUTCOME_NOT_EXECUTED = 'NOT_EXECUTED';
    ...
    */
     ...
     * Sets outcome
     *
     * @param string|null $outcome Identity verification outcome:  * **NOT_EXECUTED** - Outcome is unknown because customer didn't complete the identity verification or customer input processing isn't complete yet  * **REJECTED** - Customer failed identity verification  * **WARNING** - System is unable to make a definitive judgment. Requires  * **PASSED** - Customer passed identity verification
     *
     * @return $this
     */
     ...
     * Sets timestamp
     *
     * @param \DateTime|null $timestamp The date and time the case was created.
     *
     * @return $this
     */
