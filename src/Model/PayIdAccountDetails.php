...
/**
 * PayIdAccountDetails Class Doc Comment
 *
 ...
 */
class PayIdAccountDetails implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'PayIdAccountDetails';
    ...
    */
     ...
     * Sets branch_number
     *
     * @param string|null $branch_number BSB (Bank State Branch) of Account, 6 digits in length
     *
     * @return $this
     */
    public function setBranchNumber(?string $branch_number): static
    {
