...
/**
 * GetMandateActionsDetailsCreationPaymentInformationDto Class Doc Comment
 *
 ...
 */
class GetMandateActionsDetailsCreationPaymentInformationDto implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'GetMandateActionsDetailsCreationPaymentInformationDto';
    ...
    */
    ...
    public function setCountPerPeriod(?string $count_per_period): static
    {
        ...
        if ((!preg_match("/^(?=.{1,19}$)[0-9]{0,19}(?:\\.[0-9]{0,18})?$/", ObjectSerializer::toString($count_per_period)))) {
            throw new InvalidArgumentException("invalid value for \$count_per_period when calling GetMandateActionsDetailsCreationPaymentInformationDto., must conform to the pattern /^(?=.{1,19}$)[0-9]{0,19}(?:\\.[0-9]{0,18})?$/.");
        }
     ...
     *
     * @param string|null $first_payment_date Date of the first payment predefined in mandate.
     *
     * @return $this
     */
    public function setFirstPaymentDate(?string $first_payment_date): static
    {
        ...
        if ((!preg_match("/^(?:[1-9]\\d{3}-(?:(?:0[1-9]|1[0-2])-(?:0[1-9]|1\\d|2[0-8])|(?:0[13-9]|1[0-2])-(?:29|30)|(?:0[13578]|1[02])-31)|(?:[1-9]\\d(?:0[48]|[2468][048]|[13579][26])|(?:[2468][048]|[13579][26])00)-02-29)$/", ObjectSerializer::toString($first_payment_date)))) {
            throw new InvalidArgumentException("invalid value for \$first_payment_date when calling GetMandateActionsDetailsCreationPaymentInformationDto., must conform to the pattern /^(?:[1-9]\\d{3}-(?:(?:0[1-9]|1[0-2])-(?:0[1-9]|1\\d|2[0-8])|(?:0[13-9]|1[0-2])-(?:29|30)|(?:0[13578]|1[02])-31)|(?:[1-9]\\d(?:0[48]|[2468][048]|[13579][26])|(?:[2468][048]|[13579][26])00)-02-29)$/.");
        }
     ...
     *
     * @param string|null $last_payment_date Date of the last payment predefined in mandate.
     *
     * @return $this
     */
    public function setLastPaymentDate(?string $last_payment_date): static
    {
        ...
        if ((!preg_match("/^(?:[1-9]\\d{3}-(?:(?:0[1-9]|1[0-2])-(?:0[1-9]|1\\d|2[0-8])|(?:0[13-9]|1[0-2])-(?:29|30)|(?:0[13578]|1[02])-31)|(?:[1-9]\\d(?:0[48]|[2468][048]|[13579][26])|(?:[2468][048]|[13579][26])00)-02-29)$/", ObjectSerializer::toString($last_payment_date)))) {
            throw new InvalidArgumentException("invalid value for \$last_payment_date when calling GetMandateActionsDetailsCreationPaymentInformationDto., must conform to the pattern /^(?:[1-9]\\d{3}-(?:(?:0[1-9]|1[0-2])-(?:0[1-9]|1\\d|2[0-8])|(?:0[13-9]|1[0-2])-(?:29|30)|(?:0[13578]|1[02])-31)|(?:[1-9]\\d(?:0[48]|[2468][048]|[13579][26])|(?:[2468][048]|[13579][26])00)-02-29)$/.");
        }
     ...
     *
     * @param string|null $payment_amount_type Identifies the mandate payment arrangement. * **BALLOON**: Payment amount is fixed with large final payment amount. * **FIXED**: Payment amount is fixed. * **USAGE_BASED**: Payment amount is based on usage. * **VARIABLE**: Payment amount is variable.
     *
     * @return $this
     */
     ...
     *
     * @param string|null $payment_execute_not_before_time Indicates that each execution of the mandate payment should not occur before a given time of that execution day.
     *
     * @return $this
     */
    public function setPaymentExecuteNotBeforeTime(?string $payment_execute_not_before_time): static
    {
        ...
        if ((!preg_match("/^(?:[01]\\d|2[0-3]):[0-5]\\d:[0-5]\\d(?:\\.[0-9]{1,3})?(?:Z)|(-)$/", ObjectSerializer::toString($payment_execute_not_before_time)))) {
            throw new InvalidArgumentException("invalid value for \$payment_execute_not_before_time when calling GetMandateActionsDetailsCreationPaymentInformationDto., must conform to the pattern /^(?:[01]\\d|2[0-3]):[0-5]\\d:[0-5]\\d(?:\\.[0-9]{1,3})?(?:Z)|(-)$/.");
        }
    ...
    public function setPointInTime(?string $point_in_time): static
    {
        ...
        if ((!preg_match("/^[0-9]{2}$/", ObjectSerializer::toString($point_in_time)))) {
            throw new InvalidArgumentException("invalid value for \$point_in_time when calling GetMandateActionsDetailsCreationPaymentInformationDto., must conform to the pattern /^[0-9]{2}$/.");
        }
