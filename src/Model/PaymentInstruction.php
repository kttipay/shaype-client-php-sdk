...
class PaymentInstruction implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'PaymentInstruction';
    ...
    */
     ...
     * Sets amount
     *
     * @param float|null $amount The value of payment instruction amount
     *
     * @return $this
     */
     ...
     *
     * @param \DateTime|null $creation_date_time DateTime in UTC format of payment instruction creation
     *
     * @return $this
     */
    public function setCreationDateTime(?\DateTime $creation_date_time): static
    {
     ...
     * Sets end_to_end_id
     *
     * @param string|null $end_to_end_id End to end payment instruction identification
     *
     * @return $this
     */
     ...
     * Sets id
     *
     * @param string|null $id Unique identifier of the payment instruction
     *
     * @return $this
     */
     ...
     *
     * @param string|null $transaction_status_reason_code Status Reason Information Reason Code. Reject reason code, defining the reason for the transaction status.
     *
     * @return $this
     */
