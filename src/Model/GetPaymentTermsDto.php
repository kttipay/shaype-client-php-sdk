...
/**
 * GetPaymentTermsDto Class Doc Comment
 *
 ...
 */
class GetPaymentTermsDto implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'GetPaymentTermsDto';
    ...
    */
     ...
     * Sets type
     *
     * @param string|null $type Payment type.  * **BALLOON**: Payment amount is fixed with large final payment amount.  * **FIXED**: Payment amount is fixed.  * **USAGE_BASED**: Payment amount is based on usage.  * **VARIABLE**: Payment amount is variable.
     *
     * @return $this
     */
