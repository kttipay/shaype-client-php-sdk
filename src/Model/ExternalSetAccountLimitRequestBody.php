...
/**
 * ExternalSetAccountLimitRequestBody Class Doc Comment
 *
 ...
 */
class ExternalSetAccountLimitRequestBody implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'ExternalSetAccountLimitRequestBody';
    ...
    */
    ...
    public function listInvalidProperties(): array
    {
        ...
        if ($this->container['limit_amount'] === null) {
            $invalidProperties[] = "'limit_amount' can't be null";
        }
     ...
     * Sets limit_amount
     *
     * @param float $limit_amount Custom Account limit value being applied
     *
     * @return $this
     */
