...
/**
 * CreateDebtorDetailsDto Class Doc Comment
 *
 ...
 */
class CreateDebtorDetailsDto implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'CreateDebtorDetailsDto';
    ...
    */
    ...
    public function listInvalidProperties(): array
    {
        ...
        if (!is_null($this->container['account_number']) && (mb_strlen($this->container['account_number']) > 15)) {
            $invalidProperties[] = "invalid value for 'account_number', the character length must be smaller than or equal to 15.";
        }

        if (!is_null($this->container['account_number']) && (mb_strlen($this->container['account_number']) < 11)) {
            $invalidProperties[] = "invalid value for 'account_number', the character length must be bigger than or equal to 11.";
        }
     ...
     *
     * @param string|null $account_alias_type Debtor alias type.  * **AUSTRALIAN_BUSINESS_NUMBER**: Australian business number.  * **EMAIL_ADDRESS**: E-mail address.  * **ORGANISATION_ID**: Organisation identifier.  * **PHONE_NUMBER**: Phone number.
     *
     * @return $this
     */
    ...
    public function setAccountNumber(?string $account_number): static
    {
        ...
        if ((mb_strlen($account_number) > 15)) {
            throw new InvalidArgumentException('invalid length for $account_number when calling CreateDebtorDetailsDto., must be smaller than or equal to 15.');
        }
        if ((mb_strlen($account_number) < 11)) {
            throw new InvalidArgumentException('invalid length for $account_number when calling CreateDebtorDetailsDto., must be bigger than or equal to 11.');
        }
    ...
    public function setPartyReference(?string $party_reference): static
    {
        ...
        if ((!preg_match("/^[ -~]{1,35}$/", ObjectSerializer::toString($party_reference)))) {
            throw new InvalidArgumentException("invalid value for \$party_reference when calling CreateDebtorDetailsDto., must conform to the pattern /^[ -~]{1,35}$/.");
        }
