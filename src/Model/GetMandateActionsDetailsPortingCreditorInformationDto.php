...
/**
 * GetMandateActionsDetailsPortingCreditorInformationDto Class Doc Comment
 *
 ...
 */
class GetMandateActionsDetailsPortingCreditorInformationDto implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'GetMandateActionsDetailsPortingCreditorInformationDto';
    ...
    */
    ...
    public function setAccountAliasIdentification(?string $account_alias_identification): static
    {
        ...
        if ((mb_strlen($account_alias_identification) > 2048)) {
            throw new InvalidArgumentException('invalid length for $account_alias_identification when calling GetMandateActionsDetailsPortingCreditorInformationDto., must be smaller than or equal to 2048.');
        }
        if ((mb_strlen($account_alias_identification) < 1)) {
            throw new InvalidArgumentException('invalid length for $account_alias_identification when calling GetMandateActionsDetailsPortingCreditorInformationDto., must be bigger than or equal to 1.');
        }
    ...
    public function setAccountIdentificationIssuer(?string $account_identification_issuer): static
    {
        ...
        if ((!preg_match("/^[ -~]{1,35}$/", ObjectSerializer::toString($account_identification_issuer)))) {
            throw new InvalidArgumentException("invalid value for \$account_identification_issuer when calling GetMandateActionsDetailsPortingCreditorInformationDto., must conform to the pattern /^[ -~]{1,35}$/.");
        }
    ...
    public function setAccountNumber(?string $account_number): static
    {
        ...
        if ((!preg_match("/^[ -~]{11,15}$/", ObjectSerializer::toString($account_number)))) {
            throw new InvalidArgumentException("invalid value for \$account_number when calling GetMandateActionsDetailsPortingCreditorInformationDto., must conform to the pattern /^[ -~]{11,15}$/.");
        }
    ...
    public function setAccountServicerBic(?string $account_servicer_bic): static
    {
        ...
        if ((!preg_match("/^[A-Z0-9]{4}[A-Z]{2}[A-Z0-9]{2}[A-Z0-9]{3}$/", ObjectSerializer::toString($account_servicer_bic)))) {
            throw new InvalidArgumentException("invalid value for \$account_servicer_bic when calling GetMandateActionsDetailsPortingCreditorInformationDto., must conform to the pattern /^[A-Z0-9]{4}[A-Z]{2}[A-Z0-9]{2}[A-Z0-9]{3}$/.");
        }
    ...
    public function setFullLegalAccountName(?string $full_legal_account_name): static
    {
        ...
        if ((!preg_match("/^[ -~]{1,140}$/", ObjectSerializer::toString($full_legal_account_name)))) {
            throw new InvalidArgumentException("invalid value for \$full_legal_account_name when calling GetMandateActionsDetailsPortingCreditorInformationDto., must conform to the pattern /^[ -~]{1,140}$/.");
        }
    ...
    public function setPartyIdentification(?string $party_identification): static
    {
        ...
        if ((!preg_match("/^[ -~]{1,35}$/", ObjectSerializer::toString($party_identification)))) {
            throw new InvalidArgumentException("invalid value for \$party_identification when calling GetMandateActionsDetailsPortingCreditorInformationDto., must conform to the pattern /^[ -~]{1,35}$/.");
        }
    ...
    public function setPartyName(?string $party_name): static
    {
        ...
        if ((!preg_match("/^[ -~]{1,140}$/", ObjectSerializer::toString($party_name)))) {
            throw new InvalidArgumentException("invalid value for \$party_name when calling GetMandateActionsDetailsPortingCreditorInformationDto., must conform to the pattern /^[ -~]{1,140}$/.");
        }
    ...
    public function setPartyReference(?string $party_reference): static
    {
        ...
        if ((!preg_match("/^[ -~]{1,35}$/", ObjectSerializer::toString($party_reference)))) {
            throw new InvalidArgumentException("invalid value for \$party_reference when calling GetMandateActionsDetailsPortingCreditorInformationDto., must conform to the pattern /^[ -~]{1,35}$/.");
        }
    ...
    public function setUltimatePartyName(?string $ultimate_party_name): static
    {
        ...
        if ((!preg_match("/^[ -~]{1,140}$/", ObjectSerializer::toString($ultimate_party_name)))) {
            throw new InvalidArgumentException("invalid value for \$ultimate_party_name when calling GetMandateActionsDetailsPortingCreditorInformationDto., must conform to the pattern /^[ -~]{1,140}$/.");
        }
