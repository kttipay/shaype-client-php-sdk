...
class MerchantAddress implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('single_line_address', $data ?? [], null);
    ...
    */
     ...
     *
     * @param string|null $single_line_address single_line_address
     *
     * @return $this
     */
    public function setSingleLineAddress(?string $single_line_address): static
    {
        if (is_null($single_line_address)) {
            throw new InvalidArgumentException('non-nullable single_line_address cannot be null');
        }
