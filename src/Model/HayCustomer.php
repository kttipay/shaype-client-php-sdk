...
class HayCustomer implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    public const STATUS_REASON_SUSPICIOUS = 'SUSPICIOUS';
    public const STATUS_REASON_DECEASED = 'DECEASED';
    public const STATUS_REASON_CUSTOMER = 'CUSTOMER';
    public const STATUS_REASON_OPERATIONAL = 'OPERATIONAL';
    ...
    {
        return [
            self::STATUS_REASON_SUSPICIOUS,
            self::STATUS_REASON_DECEASED,
            self::STATUS_REASON_CUSTOMER,
            self::STATUS_REASON_OPERATIONAL,
        ];
    }
    ...
    */
     ...
     * Sets status_reason
     *
     * @param string|null $status_reason INACTIVE status reason. Possible values:  * **SUSPICIOUS**: The customer was made inactive due to concerns about their account conduct.  * **DECEASED**: The customer was made inactive after confirmation was received that they are deceased.  * **CUSTOMER**: The customer was made inactive due to a customer request.  * **OPERATIONAL**: The customer was made inactive due to an operational request.
     *
     * @return $this
     */
