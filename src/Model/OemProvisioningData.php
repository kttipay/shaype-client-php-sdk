...
/**
 * OemProvisioningData Class Doc Comment
 *
 ...
 */
class OemProvisioningData implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'OemProvisioningData';
    ...
    */
     ...
     *
     * @param string|null $card_holder_name Cardholder name as printed on the Card
     *
     * @return $this
     */
     ...
     * Sets card_token
     *
     * @param string|null $card_token Public token of the Card
     *
     * @return $this
     */
     ...
     * Sets expiry_date
     *
     * @param string|null $expiry_date Expiry date of the Card (date of the last day of the expiry month and year)
     *
     * @return $this
     */
     ...
     * Sets otp
     *
     * @param string|null $otp One-time password for wallet provisioning, 6 digits in length
     *
     * @return $this
     */
