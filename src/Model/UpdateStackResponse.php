 ...
 */
class UpdateStackResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'UpdateStackResponse';
    ...
    public const ERROR_OPEN_STACKS_LIMIT_REACHED = 'OPEN_STACKS_LIMIT_REACHED';
    public const ERROR_TOTAL_STACKS_LIMIT_REACHED = 'TOTAL_STACKS_LIMIT_REACHED';
    public const ERROR_STACK_NAME_ALREADY_IN_USE = 'STACK_NAME_ALREADY_IN_USE';
    ...
    {
        return [
            self::ERROR_OPEN_STACKS_LIMIT_REACHED,
            self::ERROR_TOTAL_STACKS_LIMIT_REACHED,
            self::ERROR_STACK_NAME_ALREADY_IN_USE,
        ];
    }
