...
/**
 * GenerateRapainTransactionStatusInformation Class Doc Comment
 *
 ...
 */
class GenerateRapainTransactionStatusInformation implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'GenerateRapainTransactionStatusInformation';
    ...
    public const TRANSACTION_STATUS_ACCPRJCT = 'ACCP,RJCT';
    ...
    {
        return [
            self::TRANSACTION_STATUS_ACCPRJCT,
        ];
    }
    ...
    */
     ...
     *
     * @param string $transaction_status Specifies the status of an individual payment instructions..  * **ACCP**: Accepted.  * **RJCT**: Rejected.
     *
     * @return $this
     */
