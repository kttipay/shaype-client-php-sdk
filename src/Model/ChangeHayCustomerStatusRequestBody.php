...
/**
 * ChangeHayCustomerStatusRequestBody Class Doc Comment
 *
 ...
 */
class ChangeHayCustomerStatusRequestBody implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'ChangeHayCustomerStatusRequestBody';
    ...
    public const NEW_STATUS_ACTIVE = 'ACTIVE';
    public const NEW_STATUS_INACTIVE = 'INACTIVE';
    public const NEW_STATUS_REJECTED = 'REJECTED';
    public const NEW_STATUS_BLOCKED = 'BLOCKED';
    public const NEW_STATUS_PENDING_APPROVAL = 'PENDING_APPROVAL';
    public const NEW_STATUS_REFERRED = 'REFERRED';
    ...
    {
        return [
            self::NEW_STATUS_ACTIVE,
            self::NEW_STATUS_INACTIVE,
            self::NEW_STATUS_REJECTED,
            self::NEW_STATUS_BLOCKED,
            self::NEW_STATUS_PENDING_APPROVAL,
            self::NEW_STATUS_REFERRED,
        ];
    }
    ...
    */
     ...
     * Sets new_status
     *
     * @param string $new_status Allowed Customer status. Possible values:  * **ACTIVE**: Customer is active  * **INACTIVE**: Customer is not active (closed)  * **PENDING_APPROVAL**: Customer is awaiting approval  * **REFERRED**: Customer is referred for further KYC checks  * **REJECTED**: Customer has been rejected
     *
     * @return $this
     */
