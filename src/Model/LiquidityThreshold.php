...
/**
 * LiquidityThreshold Class Doc Comment
 *
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class LiquidityThreshold implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'LiquidityThreshold';
    ...
    */
    ...
    public function setAmount(?float $amount): static
    {
        ...
        if (($amount < 1)) {
            throw new InvalidArgumentException('invalid value for $amount when calling LiquidityThreshold., must be bigger than or equal to 1.');
        }
    ...
    public function setPercent(?int $percent): static
    {
        ...
        if (($percent > 100)) {
            throw new InvalidArgumentException('invalid value for $percent when calling LiquidityThreshold., must be smaller than or equal to 100.');
        }
        if (($percent < 1)) {
            throw new InvalidArgumentException('invalid value for $percent when calling LiquidityThreshold., must be bigger than or equal to 1.');
        }
     ...
     * Sets percental
     *
     * @param bool|null $percental percental
     *
     * @return $this
     */
