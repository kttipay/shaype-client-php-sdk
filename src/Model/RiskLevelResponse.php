...
/**
 * RiskLevelResponse Class Doc Comment
 *
 ...
 */
class RiskLevelResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'RiskLevelResponse';
    ...
    */
     ...
     * Sets risk_level
     *
     * @param string|null $risk_level Account risk level. Possible values:  * **LOW**: Account has a low risk level, operating normally using standard Product limits  * **HIGH**: Account has a high risk level, operating at restricted capacity using applicable limits (generally prevents all outgoing funds activity
     *
     * @return $this
     */
