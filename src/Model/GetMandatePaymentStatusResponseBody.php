...
/**
 * GetMandatePaymentStatusResponseBody Class Doc Comment
 *
 ...
 */
class GetMandatePaymentStatusResponseBody implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'GetMandatePaymentStatusResponseBody';
    ...
    */
    ...
    public function listInvalidProperties(): array
    {
        ...
        if ($this->container['transaction_status_reason_code'] === null) {
            $invalidProperties[] = "'transaction_status_reason_code' can't be null";
        }
     ...
     *
     * @param string $transaction_status_reason_code Reject reason code, defining the reason for the transaction status.
     *
     * @return $this
     */
