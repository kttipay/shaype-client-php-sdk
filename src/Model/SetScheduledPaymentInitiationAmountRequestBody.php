 ...
 */
class SetScheduledPaymentInitiationAmountRequestBody implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'SetScheduledPaymentInitiationAmountRequestBody';
