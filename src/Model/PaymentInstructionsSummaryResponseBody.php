 ...
 */
class PaymentInstructionsSummaryResponseBody implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'PaymentInstructionsSummaryResponseBody';
