...
/**
 * CurrencyAmountDto Class Doc Comment
 *
 ...
 */
class CurrencyAmountDto implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'CurrencyAmountDto';
    ...
    */
    ...
    public function setAmount(?string $amount): static
    {
        ...
        if ((!preg_match("/^(?=.{1,19}$)[0-9]{0,18}(?:\\.[0-9]{0,2})?$/", ObjectSerializer::toString($amount)))) {
            throw new InvalidArgumentException("invalid value for \$amount when calling CurrencyAmountDto., must conform to the pattern /^(?=.{1,19}$)[0-9]{0,18}(?:\\.[0-9]{0,2})?$/.");
        }
    ...
    public function setCurrency(?string $currency): static
    {
        ...
        if ((!preg_match("/^[A-Z]{3}$/", ObjectSerializer::toString($currency)))) {
            throw new InvalidArgumentException("invalid value for \$currency when calling CurrencyAmountDto., must conform to the pattern /^[A-Z]{3}$/.");
        }
