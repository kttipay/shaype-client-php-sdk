...
/**
 * AmendMandateByInitiatorRequestBody Class Doc Comment
 *
 ...
 */
class AmendMandateByInitiatorRequestBody implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'AmendMandateByInitiatorRequestBody';
    ...
    protected static array $setters = [
        'creditor_account_id' => 'setCreditorAccountId',
    ...
    protected static array $getters = [
        'creditor_account_id' => 'getCreditorAccountId',
    ...
    {
        $this->setIfExists('creditor_account_id', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties(): array
    {
        ...
        if ($this->container['creditor_account_id'] === null) {
            $invalidProperties[] = "'creditor_account_id' can't be null";
        }
    ...
    /**
     * Gets creditor_account_id
     *
     * @return string
     */
    public function getCreditorAccountId(): string
    {
        return $this->container['creditor_account_id'];
    }

    /**
     * Sets creditor_account_id
     *
     * @param string $creditor_account_id The identifier of the creditor account.
     *
     * @return $this
     */
    public function setCreditorAccountId(string $creditor_account_id): static
    {
        if (is_null($creditor_account_id)) {
            throw new InvalidArgumentException('non-nullable creditor_account_id cannot be null');
        }
        $this->container['creditor_account_id'] = $creditor_account_id;
