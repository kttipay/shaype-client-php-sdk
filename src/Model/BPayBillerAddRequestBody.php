...
/**
 * BPayBillerAddRequestBody Class Doc Comment
 *
 ...
 */
class BPayBillerAddRequestBody implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'BPayBillerAddRequestBody';
    ...
    */
    ...
    public function setBillerCode(string $biller_code): static
    {
        ...
        if ((mb_strlen($biller_code) > 10)) {
            throw new InvalidArgumentException('invalid length for $biller_code when calling BPayBillerAddRequestBody., must be smaller than or equal to 10.');
        }
        if ((mb_strlen($biller_code) < 3)) {
            throw new InvalidArgumentException('invalid length for $biller_code when calling BPayBillerAddRequestBody., must be bigger than or equal to 3.');
        }
     ...
     * Sets name
     *
     * @param string $name Nick name of the BPAY biller
     *
     * @return $this
     */
