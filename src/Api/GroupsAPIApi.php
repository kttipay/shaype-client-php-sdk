...
class GroupsAPIApi
{
    ...
    ): array
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if (in_array('\Shaype\Client\Model\HayJointAccount', ['\SplFileObject', '\Psr\Http\Message\StreamInterface'])) {
    ...
    ): array
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if (in_array('\Shaype\Client\Model\HayGroup', ['\SplFileObject', '\Psr\Http\Message\StreamInterface'])) {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
     ...
     *
     * @param  string $group_hay_id Unique identifier (UUID) of the Group (required)
     * @param  \Shaype\Client\Model\RemoveCustomerFromGroupRequestBody $remove_customer_from_group_request_body remove_customer_from_group_request_body (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['removeCustomerFromGroup'] to see the possible values for this operation
     *
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return \Shaype\Client\Model\HayJointAccount|\Shaype\Client\Model\ErrorResponse|\Shaype\Client\Model\ErrorResponse|\Shaype\Client\Model\ErrorResponse|\Shaype\Client\Model\ErrorResponse|\Shaype\Client\Model\ErrorResponse
    ...
    public function removeCustomerFromGroup(
        string $group_hay_id,
        \Shaype\Client\Model\RemoveCustomerFromGroupRequestBody $remove_customer_from_group_request_body,
        string $contentType = self::contentTypes['removeCustomerFromGroup'][0]
    ): \Shaype\Client\Model\HayJointAccount
    {
        list($response) = $this->removeCustomerFromGroupWithHttpInfo($group_hay_id, $remove_customer_from_group_request_body, $contentType);
        return $response;
    }

    /**
     * Operation removeCustomerFromGroupWithHttpInfo
     *
     * Remove a Customer from a Group
     *
     * @param  string $group_hay_id Unique identifier (UUID) of the Group (required)
     * @param  \Shaype\Client\Model\RemoveCustomerFromGroupRequestBody $remove_customer_from_group_request_body (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['removeCustomerFromGroup'] to see the possible values for this operation
     *
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return array of \Shaype\Client\Model\HayJointAccount|\Shaype\Client\Model\ErrorResponse|\Shaype\Client\Model\ErrorResponse|\Shaype\Client\Model\ErrorResponse|\Shaype\Client\Model\ErrorResponse|\Shaype\Client\Model\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function removeCustomerFromGroupWithHttpInfo(
        string $group_hay_id,
        \Shaype\Client\Model\RemoveCustomerFromGroupRequestBody $remove_customer_from_group_request_body,
        string $contentType = self::contentTypes['removeCustomerFromGroup'][0]
    ): array
    {
        $request = $this->removeCustomerFromGroupRequest($group_hay_id, $remove_customer_from_group_request_body, $contentType);
    ...
    /**
     * Operation removeCustomerFromGroupAsync
     *
     * Remove a Customer from a Group
     *
     * @param  string $group_hay_id Unique identifier (UUID) of the Group (required)
     ...
     * @return PromiseInterface
     */
    public function removeCustomerFromGroupAsync(
        string $group_hay_id,
        \Shaype\Client\Model\RemoveCustomerFromGroupRequestBody $remove_customer_from_group_request_body,
        string $contentType = self::contentTypes['removeCustomerFromGroup'][0]
    ): PromiseInterface
    {
        return $this->removeCustomerFromGroupAsyncWithHttpInfo($group_hay_id, $remove_customer_from_group_request_body, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation removeCustomerFromGroupAsyncWithHttpInfo
     *
     * Remove a Customer from a Group
     *
     * @param  string $group_hay_id Unique identifier (UUID) of the Group (required)
     ...
     * @return PromiseInterface
     */
    public function removeCustomerFromGroupAsyncWithHttpInfo(
        $group_hay_id,
        $remove_customer_from_group_request_body,
        string $contentType = self::contentTypes['removeCustomerFromGroup'][0]
    ): PromiseInterface
    {
        $returnType = '\Shaype\Client\Model\HayJointAccount';
    ...
    /**
     * Create request for operation 'removeCustomerFromGroup'
     *
     * @param  string $group_hay_id Unique identifier (UUID) of the Group (required)
     * @param  \Shaype\Client\Model\RemoveCustomerFromGroupRequestBody $remove_customer_from_group_request_body (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['removeCustomerFromGroup'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function removeCustomerFromGroupRequest(
        $group_hay_id,
        $remove_customer_from_group_request_body,
        string $contentType = self::contentTypes['removeCustomerFromGroup'][0]
    ): Request
    {
        ...
        if ($group_hay_id === null || (is_array($group_hay_id) && count($group_hay_id) === 0)) {
            throw new InvalidArgumentException(
                'Missing the required parameter $group_hay_id when calling removeCustomerFromGroup'
            );
        }

        // verify the required parameter 'remove_customer_from_group_request_body' is set
        if ($remove_customer_from_group_request_body === null || (is_array($remove_customer_from_group_request_body) && count($remove_customer_from_group_request_body) === 0)) {
            throw new InvalidArgumentException(
                'Missing the required parameter $remove_customer_from_group_request_body when calling removeCustomerFromGroup'
            );
        }


        $resourcePath = '/v0/groups/{groupHayId}/removeCustomer';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // for model (json/xml)
        if (isset($remove_customer_from_group_request_body)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($remove_customer_from_group_request_body));
            } else {
                $httpBody = $remove_customer_from_group_request_body;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
